...
const MOCK_POSTS = [
    {
        id: 1,
        title: "A Verdade Sobre os Adoçantes Artificiais",
        summary: "Descubra quais adoçantes são seguros para sua microbiota e quais você deve evitar a todo custo.",
        content_markdown: "## O Que Dizem os Estudos?\n\nAdoçantes como sucralose e aspartame têm sido associados a alterações na microbiota intestinal...",
        tags: ["Nutrição", "Saúde Intestinal"],
        estimated_read_time: "5 min",
        image_url: "https://images.unsplash.com/photo-1515023115689-589c33041697?q=80&w=2070&auto=format&fit=crop",
        author_ai: true,
        created_at: new Date().toISOString()
    },
    {
        id: 2,
        title: "Microplásticos na Água: Como se Proteger",
        summary: "Um guia prático para filtrar sua água e reduzir a ingestão de partículas plásticas invisíveis.",
        tags: ["Ambiente", "Prevenção"],
        estimated_read_time: "3 min",
        image_url: "https://images.unsplash.com/photo-1548839140-29a749e1cf4d?q=80&w=1978&auto=format&fit=crop",
        author_ai: true,
                    ...
                    <div className="px-6 -mt-10 relative z-10">
                        <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-gray-100 min-h-screen">
                            ...
                            <div className="flex items-center gap-4 text-gray-400 text-xs font-bold mb-8 border-b border-gray-100 pb-6">
                                <span className="flex items-center gap-1"><Clock size={14} /> {selectedPost.estimated_read_time}</span>
                            ...
                            <div className="prose prose-lg prose-gray">
                                ...
                                <div className="text-gray-800 font-medium leading-relaxed space-y-4">
                                    ...
                                    {selectedPost.content_markdown.split('\n\n').map((para, i) => {
